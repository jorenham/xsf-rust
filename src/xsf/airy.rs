...
mod tests {
    ...
    fn test_ai_zeros() {
        ...
        crate::np_assert_allclose!(&a, &[-2.33810741, -4.08794944, -5.52055983], atol = 1e-8);
        // >>> ap
        // array([-1.01879297, -3.24819758, -4.82009921])
        crate::np_assert_allclose!(&ap, &[-1.01879297, -3.24819758, -4.82009921], atol = 1e-8);
        // >>> ai
        // array([ 0.53565666, -0.41901548,  0.38040647])
        crate::np_assert_allclose!(&ai, &[0.53565666, -0.41901548, 0.38040647], atol = 1e-8);
        // >>> aip
        // array([ 0.70121082, -0.80311137,  0.86520403])
        crate::np_assert_allclose!(&aip, &[0.70121082, -0.80311137, 0.86520403], atol = 1e-8);
    }
    ...
    fn test_bi_zeros() {
        ...
        crate::np_assert_allclose!(&b, &[-1.17371322, -3.2710933, -4.83073784], atol = 1e-8);
        // >>> bp
        // array([-2.29443968, -4.07315509, -5.51239573])
        crate::np_assert_allclose!(&bp, &[-2.29443968, -4.07315509, -5.51239573], atol = 1e-8);
        // >>> bi
        // array([-0.45494438,  0.39652284, -0.36796916])
        crate::np_assert_allclose!(&bi, &[-0.45494438, 0.39652284, -0.36796916], atol = 1e-8);
        // >>> bip
        // array([ 0.60195789, -0.76031014,  0.83699101])
        crate::np_assert_allclose!(&bip, &[0.60195789, -0.76031014, 0.83699101], atol = 1e-8);
    }
}
