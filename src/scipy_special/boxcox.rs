...
///
/// Corresponds to [`scipy.special.boxcox`][scipy].
///
...
///
/// Corresponds to [`scipy.special.boxcox1p`][scipy].
///
...
///
/// Corresponds to [`scipy.special.inv_boxcox`][scipy].
///
...
///
/// Corresponds to [`scipy.special.inv_boxcox1p`][scipy].
///
...
mod tests {
    ...
    fn test_boxcox_underflow() {
        ...
        crate::np_assert_allclose!(&[y], &[x.ln()], rtol = 1e-14);
    }
    ...
    fn test_boxcox1p_basic() {
        ...
        crate::np_assert_allclose!(&y, &x, atol = 1.5e-7);
    ...
    fn test_boxcox1p_underflow() {
        ...
        crate::np_assert_allclose!(&y, &x, rtol = 1e-14);
    }
    ...
    fn test_inv_boxcox() {
        ...
        crate::np_assert_allclose!(&x, &x2, atol = 1.5e-7);
    ...
    fn test_boxcox_premature_overflow() {
        ...
        crate::np_assert_allclose!(&x, &x_inv, rtol = 1e-7, atol = f64::EPSILON);
        ...
        crate::np_assert_allclose!(&x1m, &x1p_inv, rtol = 1e-7, atol = f64::EPSILON);
    }
}
