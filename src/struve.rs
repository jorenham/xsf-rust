...
mod tests {
    ...
    fn test_itstruve0_f64() {
        testing::test::<f64, _>("itstruve0", "d-d", |x: &[f64]| itstruve0(x[0]));
    }

    #[test]
    fn test_it2struve0_f64() {
        testing::test::<f64, _>("it2struve0", "d-d", |x: &[f64]| it2struve0(x[0]));
    }

    #[test]
    fn test_itmodstruve0_f64() {
        testing::test::<f64, _>("itmodstruve0", "d-d", |x: &[f64]| itmodstruve0(x[0]));
    }

    #[test]
    fn test_struve_h_f64() {
        testing::test::<f64, _>("struve_h", "d_d-d", |x: &[f64]| struve_h(x[0], x[1]));
    }

    #[test]
    fn test_struve_l_f64() {
        testing::test::<f64, _>("struve_l", "d_d-d", |x: &[f64]| struve_l(x[0], x[1]));
    }
}
